  ...
  return (
    <listContext.Provider value={contextValue}>
      <Grid
        ...
        background= 'var(--modal-80)'
        className="List"
        ref={mergeRef(listRef, ref)}
        gridTemplateColumns={
          gridSlotItemMinWidth != null
            ? `repeat(auto-fill, minmax(${gridSlotItemMinWidth * 1.5}px, 1fr))` // Increase the minWidth
            : gridSlotItemWidth != null
            ? `repeat(auto-fill, ${gridSlotItemWidth * 1.5}px)` // Increase the width
            : gridSlotCount != null
