...
export default function TokenAvatarPair({
  ...
  return (
    <Flex {...restProps}>
      <TokenAvatar bgBlur={bgBlur} bg="var(--Neutrals-Neutral-900)" size={size} token={token1} tokenMint={tokenMint1} icon={icon1} name={name1} />
      <TokenAvatar bgBlur={bgBlur} bg="var(--Neutrals-Neutral-900)" size={size} token={token2} tokenMint={tokenMint2} icon={icon2} name={name2} marginLeft={marginLeft} />
    </Flex>
  )
}
