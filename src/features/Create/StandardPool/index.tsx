...
export default function CreatePool() {
  ...
  return (
    ...
    >
      ...
      <GridItem area="note">
        <Box w={['unset', 'clamp(300px, 100%, 500px)']} border="1px solid var(--System-Info)" rounded="20px">
          <SubPageNote
            title={<Text color={'var(--System-Info)'}>{t('create_standard_pool.please_note')}</Text>}
            description={
