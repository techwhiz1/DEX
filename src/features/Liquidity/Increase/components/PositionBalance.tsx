...
export default function PositionBalance({ myPosition = '345.02', staked = '256.45', unstaked = '0' }: PositionBalanceProps) {
  ...
  return (
    <Flex {...panelCard} py="22px" px="24px" bg={colors.backgroundTransparentNew} border={"1px solid"} borderColor={colors.borderColorNew} borderRadius="20px" direction="column">
