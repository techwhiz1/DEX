        ...
        >
          <Flex align="center" gap={[2, 4]}>
            ...
            >
              ...
              >
                ...
                <GridItem area="n">
                  <Text
                    color={isLight ? 'var(--Neutrals-Neutral-200)' : 'var(--Neutrals-Neutral-200)'}
                    fontSize={['md', '24px']}
                    fontWeight="700"
                    textAlign="center"
                  >
                ...
                <GridItem area="t">
                  <HStack align="center">
                    <Tag size="13px" px="10px" py="4px" color="white" variant="rounded" borderRadius="4px">
          ...
          <Desktop>
            <HStack justify={'flex-end'} gap={2}>
              <Text fontSize={['sm', 'lg']} textAlign={'right'} color="var(--Neutrals-Neutral-200)">
          ...
          <Text as={'span'} fontSize={['sm', 'lg']} textAlign={'right'} color="var(--Neutrals-Neutral-200)">
              ...
              <Box>
                <Tooltip label={t('liquidity_pools.view_chart_tooltip')}>
                  <Box
                    ...
                    cursor={'pointer'}
                    rounded={'8px'}
                    border={`1px solid var(--Neutrals-Neutral-500, #3E5DB0)`}
                    px={3}
                    py={1}
                    background={'var(--Neutrals-Neutral-700, #222F54)'}
                    gap="10px"
                    padding="6px"
                    alignItems="center"
                    onClick={onOpenChart}
