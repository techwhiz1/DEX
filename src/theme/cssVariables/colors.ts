export const darkColors: Record<keyof typeof colors, string> = {
  ...
  GlassCard: 'rgba(23, 28, 39, 0.16)',
  GlassCardSecondary: 'rgba(35, 45, 72, 0.56)',
  ...
  backgroundTransparentNew: "#0C0B0BCC",
  borderColorNew: "#3E5DB0",

  PrimarySolanaBlueLink: '#46DDF3',
  PrimarySolanaPurple: '#AF1CC1',
  PrimarySolanaBlue: '#3E5CB0',

  SolHover:"rgba(138, 169, 255, 0.08)",
  ...
  // button
  buttonPrimary: 'linear-gradient(86deg, #3E5DB0 38.24%, #678CF2 100%)',
  ...
  //Success
  systemSuccessLight: '#A0FF41',
  systemSuccessBG: 'rgba(85, 182, 1, 0.24)',
  SystemInfo: '#48F4FF',
  InfoBG: 'rgba(72, 244, 255, 0.08)',
  ...
  priceFloatingUp: '#A0FF41',
  priceFloatingDown: '#FF3737',
  ...
  solidButtonBg: 'linear-gradient(272.03deg, #405eae 2.63%, #405eae 95.31%)',
...
export const colors = {
  ...
  GlassCardSecondary: 'var(--Glass-Card-Secondary)',

  neutral200: 'var(--Neutrals-Neutral-200)',
  neutral300: 'var(--Neutrals-Neutral-300)',
  neutral400: 'var(--Neutrals-Neutral-400)',
  neutral500: 'var(--Neutrals-Neutral-500)',
  neutral600: 'var(--Neutrals-Neutral-600)',
  neutral700: 'var(--Neutrals-Neutral-700)',
  neutral800: 'var(--Neutrals-Neutral-800)',
  neutral900: 'var(--Neutrals-Neutral-900)',

  modal80: 'var(--modal-80)',
  ...
  PrimarySolanaBlueLink: 'var(--Primary-Solana-Blue-Link)',
  PrimarySolanaPurple: 'var(--Primary-Solana-Purple)',
  PrimarySolanaBlue: 'var(--Primary-Solana-Blue)',
  ...
  SolHover: 'var(--sol-hover)',

  //sucess
  systemSuccessLight: 'var(--System-Success-Light)',
  systemSuccessBG: 'var(--System-Success-Bg)',
  SystemInfo:'var(--System-Info)',
  InfoBG:'var(--Info-BG)',
